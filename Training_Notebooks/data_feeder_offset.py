...
class TrainSlidingWindowGenerator():
    ...
    def __init__(self, 
        ...
        self.__window_length = windowlength
        self.__crop = crop
    ...
    def load_dataset(self):
        ...
        if (self.total_size <= self.__ram_threshold):
            ...
            maximum_batch_size = inputs.size - self.__window_length
            ...
            while True:
                for start_index in range(0, maximum_batch_size, self.__batch_size):
                    ...
                    input_data = np.array([inputs[index : index + self.__window_length] for index in splice])
...
class TestSlidingWindowGenerator(object):
    ...
    def __init__(self, number_of_windows, inputs, targets, windowlength, offset):
    ...
    def load_dataset(self):
        ...
        for start_index in range(0, max_number_of_windows, self.__number_of_windows):
            ...
            input_data = np.array([self.__inputs[index : index + self.__window_length] for index in splice])
